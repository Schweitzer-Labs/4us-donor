...
ianCainHeadshot : Image
ianCainHeadshot =
    image "ian-cain-headshot.png"


ianCainLogo : Image
ianCainLogo =
    image "ian-cain-logo.png"


luisSepulvedaHeadshot : Image
luisSepulvedaHeadshot =
    image "luis-r-sepulveda.png"
